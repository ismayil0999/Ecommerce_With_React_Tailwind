...
export const data = createSlice({
    ...
    reducers: {
        ...
        addtocart: (state, action) => {
            const product = state.contacts.find(item => item.id === action.payload.id);
            const alred = state.basketitems.find(item => item.id === product.id);
...
export const { filter, search, addfavorite, menu, opensearch, closesearch, addtocart,deletebasket, pricefilter, changecategory } = data.actions
