...
export const { filter, searchProduct,login,increment,decrement,removetocart,logout,showPopup, addfavorite, menu, opensearch, closesearch, addtocart,deletebasket, pricefilter, changecategory } = data.actions
