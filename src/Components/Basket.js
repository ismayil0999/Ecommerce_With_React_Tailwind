...
const Basket = ({setOpenbasket}) => {
  ...
  return (
   ...
   <div className="w-[40%] fixed top-0 left-0 z-[1000] h-[100%] flex flex-col bg-white items-center">
...
<div className='flex fixed bottom-4 justify-between items-center p-2 bg-[#009F7F] w-[35%] rounded-full'>
